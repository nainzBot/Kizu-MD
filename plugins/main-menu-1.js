...
let zyko = `*『 KIZU - MD MULTI DEVICE 』*`
conn.send3ButtonImg(m.chat, `https://telegra.ph/file/5ffb6a27efa3fa1121176.jpg`, zyko, kabul, 'All Menu', '.? all', 'List Menu', '.tesm', 'Credit', '.credit', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://www.instagram.com/dikaaxyz_',
    mediaType: 2, 
    description: sgc,
    title: 'Kizu-MD | Multi - Device',
    body: bottime,
